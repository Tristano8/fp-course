...
printFile ::
  ...
  -> Chars
  -> IO ()
printFile filePath chars = putStrLn ("============" ++ filePath) >> putStrLn chars
...
-- void takes our IO (List ()) and throws away the inner contents
-- In the standard library this is sequence_
